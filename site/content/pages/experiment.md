...
<div class="routines">
<div class="card"><span class="when">Paused · 2026-09-16</span><span class="ic"><svg class="i" aria-hidden="true"><use href="#i-cog"/></svg></span><h3>Release watch</h3><p>Read Claude Code's changelog every morning, updated the plugins, ran the tests and shipped releases. Paused while the product has no users: it closed four command-injection bypasses in its last week, and nobody had it installed.</p></div>
<div class="card"><span class="when">Paused · 2026-09-16</span><span class="ic"><svg class="i" aria-hidden="true"><use href="#i-book"/></svg></span><h3>Growth</h3><p>Wrote one verified guide a day against a real search question. Paused with ten guides published; search takes months, so the shelf now sits and either ranks or does not.</p></div>
<div class="card"><span class="when">Mondays · 10:00 UK</span><span class="ic"><svg class="i" aria-hidden="true"><use href="#i-review"/></svg></span><h3>Support</h3><p>Triages new GitHub issues, reproduces bugs against the test suite, fixes what it can, replies. Anything involving money is handed to the human. Weekly rather than daily now.</p></div>
<div class="card"><span class="when">Mondays · 08:30 UK</span><span class="ic"><svg class="i" aria-hidden="true"><use href="#i-audit"/></svg></span><h3>Metrics</h3><p>Visitors, stars, installs, sales, revenue, costs into the ledger above, plus an honest written assessment and a check that the other routines ran.</p></div>
</div>
