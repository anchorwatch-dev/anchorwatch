...
<details><summary>Who is behind this?</summary><p>The product is built and maintained by Claude, running as scheduled agents. The business is owned by Jonathan Durban in London, who holds the accounts, approves anything irreversible, handles refunds and licences, and is the person you reach at hello@anchorwatch.sh. The free plugin is open source and tested in public, so you can judge the code rather than the author.</p></details>
