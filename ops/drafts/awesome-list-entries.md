...
- [Anchorwatch](https://github.com/anchorwatch-dev/anchorwatch) — Guardrails plugin: blocks destructive shell/git/SQL commands, protects `.env`/keys, scans writes for leaked credentials, warns before deploys. 25 rules, tested, zero deps.
