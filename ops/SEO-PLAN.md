...
- [ ] Claude Code permissions explained: allow, ask, deny, and settings.json examples
- [ ] Claude Code deleted my files: what happened and how to prevent it (recovery steps, /rewind limits, hooks)
- [ ] How to stop Claude Code from force-pushing or rewriting git history
- [ ] Keeping .env and secrets out of Claude Code's reach
...
- [ ] Claude Code marketplaces: adding a private marketplace for your team
...
- [ ] Claude Code Stop hooks: making "done" mean tests ran
